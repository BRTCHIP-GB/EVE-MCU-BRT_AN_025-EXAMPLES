...
BRT Logo_240_240x116_COMPRESSED_RGBA_ASTC_4x4_KHR
C Source
*/
...
#define BITMAP_ADDRESS_ON_FLASH <address> //address of bitmap file from Flash map after generating Flash
	...
	Gpu_Hal_LoadImageToMemory(phost, "path\\to\\BRT Logo_240_240x116_COMPRESSED_RGBA_ASTC_4x4_KHR.raw", RAM_G, LOAD);
